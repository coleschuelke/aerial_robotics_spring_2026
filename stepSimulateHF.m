...
S.eaMat = 600/quadParams.cm(1)*ones(N-1,4);
...
S.state0.omega = 585.5*ones(4, 1);
% Oversampling factor
S.oversampFact = 10;

% Make S2
S2 = S;
S2.eaMat = 800/quadParams.cm(1)*ones(N-1,4);

% Make S3
S3 = S;
S3.eaMat = 1000/quadParams.cm(1)*ones(N-1,4);

P = simulateQuadrotorDynamicsHF(S);
P2 = simulateQuadrotorDynamicsHF(S2);
P3 = simulateQuadrotorDynamicsHF(S3);
