...
% air is NiB = [0;0;omegaRdir(i)*kN(i)*omegaVec(i)^2], where omegaVec is the
% 4x1 vector of rotor angular rates.
quadParams.omegaRdir = [-1  1  -1  1];
% rotor_loc(:,i) holds the 3x1 coordinates of the tip of the ith rotor in the
