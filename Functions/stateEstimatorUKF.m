...
if INPUT_PARSING
  ...
  ip.addParameter('delt',[],@(x)issize(x,1,1));
  ip.addParameter('tk',[],@(x)issize(x,1,1));
  ip.addParameter('rpGtilde',[],@(x)issize(x,3,1));
  ip.addParameter('rbGtilde',[],@(x)issize(x,3,1));
  ip.addParameter('rxMat',[],@(x)issize(x,NaN,NaN));
  ip.addParameter('ftildeB',[],@(x)issize(x,3,1));
  ip.addParameter('omegaBtilde',[],@(x)issize(x,3,1));
